...
## [0.13.0](https://github.com/spotandjake/binaryen.ml/compare/v0.35.0...v0.13.0) (2026-03-29)


### ⚠ BREAKING CHANGES

* `Memory.get_segment_byte_offset` on Passive data sections ([#268](https://github.com/spotandjake/binaryen.ml/issues/268))
* Upgrade to Binaryen v125 ([#259](https://github.com/spotandjake/binaryen.ml/issues/259))
* Update Passes api for Binaryen v124
* Upgrade to Binaryen v124 ([#241](https://github.com/spotandjake/binaryen.ml/issues/241))
* Upgrade to Binaryen v123 ([#256](https://github.com/spotandjake/binaryen.ml/issues/256))
* Upgrade to Binaryen v122 ([#208](https://github.com/spotandjake/binaryen.ml/issues/208))
* Correct signature of `get_pass_argument` ([#247](https://github.com/spotandjake/binaryen.ml/issues/247))
* Upgrade to Binaryen v121 ([#207](https://github.com/spotandjake/binaryen.ml/issues/207))
* Upgrade to Binaryen v120 ([#206](https://github.com/spotandjake/binaryen.ml/issues/206))
* Upgrade to Binaryen v119 ([#205](https://github.com/spotandjake/binaryen.ml/issues/205))
* Upgrade to Binaryen v118 ([#204](https://github.com/spotandjake/binaryen.ml/issues/204))
...
* Add bindings for exception handling (try/throw) ([#264](https://github.com/spotandjake/binaryen.ml/issues/264)) ([bc003c7](https://github.com/spotandjake/binaryen.ml/commit/bc003c789316a98a7989929b6e67bc6d9b31b23f))
...
* Add memory64 flag to `Memory.set_memory` ([f1c9fd7](https://github.com/spotandjake/binaryen.ml/commit/f1c9fd7a9aab97bd5f4e72d9c2b41bff88969128))
...
* Allow optional return_type parameter when creating blocks ([ab737bd](https://github.com/spotandjake/binaryen.ml/commit/ab737bd4940a4534a84d1dcff2d0a42cd49cdd38))
...
* Implement optimization settings api ([#243](https://github.com/spotandjake/binaryen.ml/issues/243)) ([1f25caf](https://github.com/spotandjake/binaryen.ml/commit/1f25cafc96a1f6969a1ecca8ea778aeefae893a8))
...
* Update Passes api for Binaryen v124 ([305137a](https://github.com/spotandjake/binaryen.ml/commit/305137a264049f3f38bf8828c57aad190195ca49))
* Update to libbinaryen v108 ([#163](https://github.com/spotandjake/binaryen.ml/issues/163)) ([f0c7d7e](https://github.com/spotandjake/binaryen.ml/commit/f0c7d7e5aaad93eb75ad850387730a245db3a545))
...
* Upgrade to Binaryen v118 ([#204](https://github.com/spotandjake/binaryen.ml/issues/204)) ([6a5d0e8](https://github.com/spotandjake/binaryen.ml/commit/6a5d0e8ca24e306bc6d634bebc9f70efdf0896e0))
* Upgrade to Binaryen v119 ([#205](https://github.com/spotandjake/binaryen.ml/issues/205)) ([3a6b775](https://github.com/spotandjake/binaryen.ml/commit/3a6b77594908b1585864160a1895c9ba25319b8f))
* Upgrade to Binaryen v120 ([#206](https://github.com/spotandjake/binaryen.ml/issues/206)) ([4d69831](https://github.com/spotandjake/binaryen.ml/commit/4d6983154c19140af2ab2ac4451c5b69f0f2a736))
* Upgrade to Binaryen v121 ([#207](https://github.com/spotandjake/binaryen.ml/issues/207)) ([7e51d5d](https://github.com/spotandjake/binaryen.ml/commit/7e51d5da5bd2336dd0122468bcc1e3030e13f86c))
* Upgrade to Binaryen v122 ([#208](https://github.com/spotandjake/binaryen.ml/issues/208)) ([434417d](https://github.com/spotandjake/binaryen.ml/commit/434417df5720205824b3fdfa3ce82fa72465c444))
* Upgrade to Binaryen v123 ([#256](https://github.com/spotandjake/binaryen.ml/issues/256)) ([dd6bfa7](https://github.com/spotandjake/binaryen.ml/commit/dd6bfa7bd1c072b33bbc1731a046d169ceb9ea39))
* Upgrade to Binaryen v124 ([#241](https://github.com/spotandjake/binaryen.ml/issues/241)) ([02829f8](https://github.com/spotandjake/binaryen.ml/commit/02829f805cd3133bb4b04c83abac8380996bd0ec))
* Upgrade to Binaryen v125 ([#259](https://github.com/spotandjake/binaryen.ml/issues/259)) ([01d286f](https://github.com/spotandjake/binaryen.ml/commit/01d286f7b4533962ab10da73111fe699a8622e0f))
...
* `Memory.get_segment_byte_offset` on Passive data sections ([#268](https://github.com/spotandjake/binaryen.ml/issues/268)) ([45e4c55](https://github.com/spotandjake/binaryen.ml/commit/45e4c55147ce4cf88fe59529c2fde9d1b0a22247))
...
* Correct signature of `get_pass_argument` ([#247](https://github.com/spotandjake/binaryen.ml/issues/247)) ([986ecec](https://github.com/spotandjake/binaryen.ml/commit/986ecec07af320813f4137cfed4d454ae6c13f82))
...
* Module.optimize on macOS ([#77](https://github.com/spotandjake/binaryen.ml/issues/77)) ([0b92043](https://github.com/spotandjake/binaryen.ml/commit/0b920431372119d92b0077f51b91ca745fbfde87))
...
* Use `caml_uint8_array_of_string` in add_custom_section ([#269](https://github.com/spotandjake/binaryen.ml/issues/269)) ([0877b1e](https://github.com/spotandjake/binaryen.ml/commit/0877b1e2b8fb1df4ddb29c73bbb867875fa5f580))
...
* Require js_of_ocaml 4.1 to ensure optimization fix ([474e5cd](https://github.com/spotandjake/binaryen.ml/commit/474e5cd49b276b5becc54e6f1bf4d9c044ef5b76))
